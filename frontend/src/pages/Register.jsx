    ...
    <div className="min-h-screen bg-gray-950 flex flex-col px-6 py-8">
      ...
      <div className="flex-1 flex flex-col justify-center max-w-sm mx-auto w-full">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div>
            <label className="text-sm text-gray-400 mb-1 block">{t('register.full_name')}</label>
            <input
              type="text"
              required
          ...
          <div>
            <label className="text-sm text-gray-400 mb-1 block">{t('register.email')}</label>
            <input
              type="email"
              required
              placeholder="[email]"
          ...
          <div>
            <label className="text-sm text-gray-400 mb-1 block">{t('register.phone')}</label>
            <input
              type="tel"
              placeholder="+234..."
              value={form.phone}
          ...
          <div>
            <label className="text-sm text-gray-400 mb-1 block">{t('register.password')}</label>
